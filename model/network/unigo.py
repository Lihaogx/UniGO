...
class BackboneODE(nn.Module):
    ...
    def dxdt(self, t, x):
        ...
        Args:
            ...
            x: Current state with shape [num_supernodes, feature_dim]
            adj_w: Adjacency matrix with shape [num_supernodes, num_supernodes]
        
        Returns:
            dX/dt with shape [num_supernodes, feature_dim]
        """
